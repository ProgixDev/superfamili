...
export default function EducateurNotificationsPage() {
  ...
  const markReadMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["educator-notifications"] })
    },
  })
  ...
  const handleNotificationClick = (notif: Notification) => {
    ...
    if (notif.related_booking_id) {
      router.push(`/educateur/reservations/${notif.related_booking_id}`)
    }
  }
