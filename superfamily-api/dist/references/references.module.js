...
const references_admin_controller_1 = require("./references-admin.controller");
...
exports.ReferencesModule = ReferencesModule = __decorate([
    (0, common_1.Module)({
        controllers: [references_controller_1.ReferencesController, references_admin_controller_1.ReferencesAdminController],
